...
public class SetCat extends HashSet { // declare the class as public that extends the primitive class HashSet
     ...
     */
        ...
        /**
         * define the element that applied to a certains object of type SetSymmetricDifference, returns the object himself
         */
    ...
    public static class SetIntersection extends SetCat {
         ...
         * type
         */
        public static SetCat interIdentity(SetCat a) { return a;}//in this case the object is the set itself
         ...
         */
        public static boolean tryIdentity(SetCat b){
    ...
    /**
     * This class will check whether the operation difference (a-b) maintains the properties of Categories,
     * it extends class SetCat. The difference operation takes away all the elements not in common in one of the two set
     * with the other, and puts them in a third empty set.
     */
