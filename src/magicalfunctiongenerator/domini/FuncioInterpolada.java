...
{
    private float[][] M; // Taula de diferï¿½ncies finites.
    ...
    private void calcularTaulaDiferencies()
    {
        ...
        // Calculem la taula de diferï¿½ncies dividides finites...
        M = new float[N][N];
    ...
    // Interpolaciï¿½ mitjanï¿½ant el polinomi d'interpolaciï¿½ de Newton.
