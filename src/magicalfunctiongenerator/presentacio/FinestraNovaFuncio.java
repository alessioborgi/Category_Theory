...
public class FinestraNovaFuncio extends JDialog implements Observer
{
    ...
    private void validar()
    {
        ...
        // Crea la funciÃ³ a partir d'una cadena de carÃ cters.
        if (radiocadena.isSelected())
        {
            funcio = textcadena.getText();
            // Crea la funciÃ³ a partir de la taula de valors.
        }
        else
        {
        ...
        // ObtÃ© un grafica de funcions existent.
        else
        {
