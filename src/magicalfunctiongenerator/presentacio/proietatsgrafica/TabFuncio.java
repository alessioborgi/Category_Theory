...
public class TabFuncio extends JPanel
{
    ...
    /*buttoncolor.addActionListener(new ActionListener()
    {
      ...
      {
        Color c = JColorChooser.showDialog(FinestraPropietatsGrafica.instancia(), "Color de la funciÃ³", Color.blue);
    ...
    /*combofuncions.addItemListener(new ItemListener()
    {
      public void itemStateChanged(ItemEvent e)
      {
        ...
        jCheckBox1.setText("Mostrar funciÃ³");
